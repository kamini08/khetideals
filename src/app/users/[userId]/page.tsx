      ...
      <div className="main-content form-background">
        ...
        <div className="purchases-section text-center" id="past-purchases-section">
            ...
            {pastPurchases.length > 0 ? (
              pastPurchases.map((purchase, index) => (
                <div className="purchase-card " key={index}>
                  ...
                  <p className="mb-4">Crop Type: {purchase['product']['cropType']}</p>
          ...
          <Link href="/proposalForm">
            <button type="button"
            onClick={handleChat}
             className="text-white">Chat with the person</button>
</Link>
          </div>
          <Link href="/proposalForm">
          <div className="form-group text-center"
          >
            <button type="button" className="text-white">Make a propasal of a contract</button>
          </div>
          </Link>
